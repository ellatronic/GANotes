...
## Demo: Customize The terminal (15 mins)
...
## Independent Practice: Get comfortable with your `~/.bashrc`

Take 4 minutes and try to modify your path to include the platform-tools to your $PATH variable. The platform-tools directory is under your sdk directory.

> Check: With 1 minute left, reveal what a bash profile could look like doing this:

```
export ANDROID_HOME=~/Downloads/adt-bundle-mac-x86_64-20131030/sdk
