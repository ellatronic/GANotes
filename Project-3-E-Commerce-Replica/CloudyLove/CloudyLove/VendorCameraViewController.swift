//
//  VendorCameraViewController.swift
//  CloudyLove
//
...
class VendorCameraViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func useCamera() {
        AVCaptureDevice.requestAccess(forMediaType: AVMediaTypeVideo) { (authorized) in
            ...
            if authorized {
                ...
                let alertController = UIAlertController(title: "Camera", message: "Take a photo or choose from library", preferredStyle: UIAlertControllerStyle.actionSheet)
                ...
                let cameraAction = UIAlertAction(title: "Camera", style: UIAlertActionStyle.default, handler: { (action) in
                    ...
                    self.present(imagePicker, animated: true) //Presenting the image.
                ...
                let cameraCancel = UIAlertAction(title: "Cancel", style: UIAlertActionStyle.cancel, handler: nil)
                
                alertController.addAction(cameraAction)
                alertController.addAction(photoLibraryAction)
                alertController.addAction(cameraCancel)
                
                DispatchQueue.main.sync {
                    self.present(alertController, animated: true) //Presenting the alertController.
                }
            }
        }
...
extension VendorCameraViewController: UITextFieldDelegate {
